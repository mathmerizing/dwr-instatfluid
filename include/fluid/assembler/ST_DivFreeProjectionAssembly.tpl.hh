/**
 * @file ST_DivFreeProjectionAssembly.tpl.hh
...
#ifndef __ST_DivFreeProjectionAssembly_tpl_hh
#define __ST_DivFreeProjectionAssembly_tpl_hh
...
template<int dim>
struct DivFreeProjectionAssembly {
	...
	DivFreeProjectionAssembly(const DivFreeProjectionAssembly &scratch);
...
struct DivFreeProjectionAssembly{
	...
	DivFreeProjectionAssembly(const DivFreeProjectionAssembly &copydata);
