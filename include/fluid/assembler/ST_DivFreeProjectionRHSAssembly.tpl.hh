/**
 * @file ST_DivFreeProjectionRHSAssembly.tpl.hh
...
#ifndef __ST_DivFreeProjectionRHSAssembly_tpl_hh
#define __ST_DivFreeProjectionRHSAssembly_tpl_hh
...
template<int dim>
struct DivFreeProjectionRHSAssembly {
	DivFreeProjectionRHSAssembly(
		// space
	...
	DivFreeProjectionRHSAssembly(const DivFreeProjectionRHSAssembly &scratch);
...
struct DivFreeProjectionRHSAssembly{
	...
	DivFreeProjectionRHSAssembly(const DivFreeProjectionRHSAssembly &copydata);
