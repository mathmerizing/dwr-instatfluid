...
template<int dim>
DualDivFreeProjectionRHSAssembly<dim>::DualDivFreeProjectionRHSAssembly(const DualDivFreeProjectionRHSAssembly &scratch) :
	space_fe_values(
...
DualDivFreeProjectionRHSAssembly<dim>::DualDivFreeProjectionRHSAssembly(
	...
	vi_zn_vector(fe_s.dofs_per_cell),
	local_dof_indices(fe_s.dofs_per_cell) {
}

template<int dim>
DualDivFreeProjectionRHSAssembly<dim>::DualDivFreeProjectionRHSAssembly(const DualDivFreeProjectionRHSAssembly &copydata) :
...
//	pressure = dim;
	...
	run(
		...
		Assembly::CopyData::DualDivFreeProjectionRHSAssembly<dim> (
			*space.fe
		)
	);
}
